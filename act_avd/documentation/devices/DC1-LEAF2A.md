...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | default | 192.168.0.15/24 | 192.168.0.5 |
...
| --------- | --------------- | ------------ | --------- |
| POD2 | Vlan4094 | 10.255.252.5 | Port-Channel3 |
...
| Ethernet5 | DC1-L2LEAF2A_Ethernet1 | *trunk | *110,160,170 | *- | *- | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet3 | routed | - | 172.30.255.9/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet3 | routed | - | 172.30.255.11/31 | default | 1500 | False | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| L2-extend | 192.0.255.5:10170 | 10170:10170 | - | - | learned | 170 |
| Tenant_A_OP_Zone | 192.0.255.5:10 | 10:10 | - | - | learned | 110 |
| Tenant_A_VMOTION | 192.0.255.5:10160 | 10160:10160 | - | - | learned | 160 |
...
router bgp 65102
   ...
   neighbor 172.30.255.8 description DC1-SPINE1_Ethernet3
   neighbor 172.30.255.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.255.10 remote-as 65001
   neighbor 172.30.255.10 description DC1-SPINE2_Ethernet3
